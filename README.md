...
2. Put the directory named `hidden_service` inside HiddenServiceDir on tor_docker.
3. sh webconfgen.sh
4. Create Redis and Postgres database and .env.production
   Reference: https://peterbabic.dev/blog/running-mastodon-with-docker-compose/

   **IMPORTANT: SET ALLOW_ACCESS_TO_HIDDEN_SERVICE=true**
